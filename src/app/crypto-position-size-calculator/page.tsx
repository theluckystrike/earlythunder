...
const spec: CalculatorPageSpec = {
  ...
  intro: "Start with the dollars you are willing to lose if the stop executes. The model divides that budget by price risk plus estimated entry and exit fees, then caps the result at the entered cash account value because leverage is not modeled.",
  formulas: ["Risk budget = account value × maximum risk percentage", "Price risk per unit = |entry price − stop price|", "Fee-aware risk per unit = price risk + entry fee per unit + stop fee per unit", "Units = lesser of risk-sized units and cash available ÷ entry price"],
  sections: [
  ...
  faqs: [
    ...
    { question: "Does this calculator handle leverage?", answer: "It sizes units from entry-to-stop risk and fees. It does not calculate maintenance margin or liquidation, which vary by venue and contract." },
  ],
};
