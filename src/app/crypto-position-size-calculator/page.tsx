...
const spec: CalculatorPageSpec = {
  ...
  intro: "Start with the dollars you are willing to lose if the stop executes. The model divides that budget by price risk plus estimated entry and exit fees, then caps the result at the entered cash account value because borrowed capital is not modeled.",
