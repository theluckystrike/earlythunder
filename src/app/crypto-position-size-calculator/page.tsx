...
const spec: CalculatorPageSpec = {
  ...
  intro: "Start with the dollars you are willing to lose if the stop executes. The model divides that budget by price risk plus estimated entry and exit fees to produce units and notional size.",
  formulas: ["Risk budget = account value × maximum risk percentage", "Price risk per unit = |entry price − stop price|", "Fee-aware risk per unit = price risk + entry fee per unit + stop fee per unit", "Units = risk budget ÷ fee-aware risk per unit"],
  sections: [
